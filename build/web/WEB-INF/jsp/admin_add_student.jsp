        ...
        <form class="form-horizontal" role="form">
            <div class="form-body">
                    ...
                    <div >
                        <div class="input-inline input-medium">
                            <div class="input-group">
                                ...
                                <input id="stdid" type="text" class="form-control" placeholder="Student ID">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group ">
                    ...
                    <div class="col-md-6">
                        <select id="row_1_left" class="form-control select2me" data-placeholder="Select..."></select>
                    </div>

                    <div class="col-md-6">
                        <select id="row_1_right" class="form-control select2me" data-placeholder="Select..."></select>
                    </div>
                </div>
                <div class="form-group ">

                    <div class="col-md-6">
                        <select id="row_2_left" class="form-control select2me" data-placeholder="Select..."></select>
                    </div>

                    <div class="col-md-6">
                        <select id="row_2_right" class="form-control select2me" data-placeholder="Select..."></select>
                    </div>
                </div>
                <div class="form-group ">

                    <div class="col-md-6">
                        <select id="row_3_left" class="form-control select2me" data-placeholder="Select..."></select>
                    </div>

                    <div class="col-md-6">
                        <select id="row_3_right" class="form-control select2me" data-placeholder="Select..."></div>
                </div>
                <div class="form-group ">

                    <div class="col-md-6">
                        <select id="row_4_left" class="form-control select2me" data-placeholder="Select..."></select>
                    </div>

                    <div class="col-md-6">
                        <select id="row_4_right" class="form-control select2me" data-placeholder="Select..."></select>
                    </div>
                </div>
                <div class="form-group ">

                    <div class="col-md-6">
                        <select id="row_5_left" class="form-control select2me" data-placeholder="Select..."></select>
                    </div>

                    <div class="col-md-6">
                        <select id="row_5_right" class="form-control select2me" data-placeholder="Select..."></select>
                    </div>
                </div>
<!--                <div class="row">
...
<script>
    jQuery(document).ready(function() {
        ...
        $.post('/Fast_schedular/getCourses',function(res){
            alert(res);
        });
        $('select').change(function(){
            
            var course = "course="+String($(this).find(':selected').val());
            $.post('/fetchSections',course,function(res){
